...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`ud-header left-0 top-0 z-40 flex w-full items-center px-3 py-2 lg:px-24 ${
          sticky
            ? "shadow-nav fixed z-[999] border-b border-stroke bg-white backdrop-blur-[5px] dark:border-dark-3/20 dark:bg-dark/10"
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-white px-6 py-8 duration-300 dark:border-body-color/20 dark:bg-dark-2 lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${
                    navbarOpen
                      ? "visibility top-full opacity-100"
                      : "invisible top-[120%] opacity-0"
                  }`}
                >
                  <ul className="block lg:ml-28 lg:flex lg:gap-x-8 xl:ml-36 xl:gap-x-12">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                <Link
                  href="/signup"
                  className={`rounded px-14 py-3 text-base font-medium text-white duration-300 ease-in-out ${
                    sticky
                      ? " bg-orange-500 hover:bg-primary/90 hover:text-white"
